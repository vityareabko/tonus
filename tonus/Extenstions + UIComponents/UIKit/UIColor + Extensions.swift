...
extension UIColor {
    static let specialMainBackground = #colorLiteral(red: 0.9411764706, green: 0.9294117647, blue: 0.8862745098, alpha: 1)
    static let specialGray =           #colorLiteral(red: 0.3176470588, green: 0.3176470588, blue: 0.3137254902, alpha: 1)
    static let specialLightGreen =     #colorLiteral(red: 0.2, green: 0.5529411765, blue: 0.4901960784, alpha: 1)
    static let specialDarkGreen =      #colorLiteral(red: 0.1921568627, green: 0.3490196078, blue: 0.3215686275, alpha: 1)
    ...
    static let specialTabBar =         #colorLiteral(red: 0.1833929121, green: 0.3491438627, blue: 0.3169077039, alpha: 1)
